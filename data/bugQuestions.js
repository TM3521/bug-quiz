export const BUG_QUESTIONS = [
  ...
  },
  {
    ...
    description: "点数に応じてランクを判定するプログラムです。",
    bugLine: 3,
    bugDescription: "If/ElseIf の順序が逆。score >= 80 → >= 70 → >= 60 の順にすべき",
    explanation: "score=75 のとき最初の `If score >= 60` が True になり「C」が出力されます。条件は大きい値から並べる必要があります。",
    hint: "ElseIfの条件が評価される順番を考えてください",
    difficulty: "NORMAL",
    lines: ["Dim score As Integer = 75","","If score >= 60 Then","    Console.WriteLine(\"C\")","ElseIf score >= 70 Then","    Console.WriteLine(\"B\")","ElseIf score >= 80 Then","    Console.WriteLine(\"A\")","End If"],
  },
  {
  ...
  },
  {
    ...
    description: '文字列 "Hello, World!" の先頭5文字 "Hello" を取得するプログラムです。',
    bugLine: 3,
    bugDescription: '3行目: `s.Substring(1, 5)` → `s.Substring(0, 5)`',
    explanation: 'Substring(startIndex, length) はインデックス0始まりです。`Substring(1, 5)` では "ello," になります。',
    hint: "Substring の第1引数は何番から数え始めますか？",
    difficulty: "HARD",
    lines: ["Dim s As String = \"Hello, World!\"","","Dim result As String = s.Substring(1, 5)","Console.WriteLine(result)  ' 期待値: \"Hello\""],
  },
  {
